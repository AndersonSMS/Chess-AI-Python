...
#https://github.com/bojotamara/python-chess
#https://pt.qwe.wiki/wiki/Chess_opening
#https://www.youtube.com/watch?v=qBDD4OIVHoo
...
def run_game():
    ...
    while not gameover:
        ...
        if player == 1:
            ...
            update_sidemenu('Your Turn!'+textTime, (255, 255, 255))
                ...
                # piece is selected, now move it somewhere
                    ...
                    if square in player_moves:
                        ...
                        if (board.white_king.y, board.white_king.x) not in attacked:
                            ...
                            if checkWhite:
                                update_sidemenu(
                                    'You have to get out\nof check!'+textTime, (255, 0, 0))
                                pygame.display.update()
                                pygame.time.wait(1000)
                                update_sidemenu(
                                    'Your Turn: Check!'+textTime, (255, 0, 0))
                            else:
                                update_sidemenu(
                                    'This move would put\nyou in check!'+textTime, (255, 0, 0))
                                pygame.display.update()
                                pygame.time.wait(1000)
                                update_sidemenu('Your turn!'+textTime, (255, 255, 255))
                    ...
                    # square selected is a potential special move
                        ...
                        # special move is not valid
                            ...
                            update_sidemenu('Invalid move!'+textTime, (255, 0, 0))
                            pygame.display.update()
                            pygame.time.wait(1000)
                            if checkWhite:
                                update_sidemenu(
